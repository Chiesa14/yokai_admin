...
class textStyle {
  ...
  static final TextStyle headingSemiBold =
      TextStyle(color: colorDark, fontSize: 32, fontFamily: 'MulishSemiBold');
  ...
  static final TextStyle headingExtraBold =
      TextStyle(color: colorDark, fontSize: 32, fontFamily: 'MulishExtraBold');
  ...
  static final TextStyle subHeading =
      TextStyle(color: colorSubHeadingText, fontSize: 16, fontFamily: 'Mulish');

  static final TextStyle subHeadingColor =
      TextStyle(color: Colors.white, fontSize: 16, fontFamily: 'Open Sans');

  static final TextStyle subHeadingSemiBold = TextStyle(
      color: colorSubHeadingText, fontSize: 16, fontFamily: 'MulishSemiBold');
  ...
  static final TextStyle subHeadingExtraBold = TextStyle(
      color: colorSubHeadingText, fontSize: 16, fontFamily: 'MulishExtraBold');
  ...
  static final TextStyle smallText =
      TextStyle(color: colorSubHeadingText, fontSize: 13, fontFamily: 'Mulish');
  ...
  static final TextStyle smallTextSemiBold = TextStyle(
      color: colorSubHeadingText, fontSize: 13, fontFamily: 'MulishSemiBold');
  static final TextStyle smallTextBold = TextStyle(
      color: colorSubHeadingText, fontSize: 13, fontFamily: 'MulishBold');
  static final TextStyle smallTextExtraBold = TextStyle(
      color: colorSubHeadingText, fontSize: 13, fontFamily: 'MulishExtraBold');
...
class AppTextStyle {
  ...
  static const TextStyle smallText =
      TextStyle(color: colorSubHeadingText, fontSize: 13, fontFamily: 'Mulish');
  static const TextStyle subHeadingColor =
      TextStyle(color: Colors.white, fontSize: 16, fontFamily: 'Open Sans');
